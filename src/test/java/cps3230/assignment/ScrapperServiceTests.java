...
public class ScrapperServiceTests {
    ...
    @Test
    public void searchElementIsUnsuccessful() { 
        String itemToTest = "text";

        Assertions.assertEquals(scrapperTester.searchItem(itemToTest), true); 
    }
    ...
    // repeat above test for other items 
    // repeat one for fail test aka where there is null path // false 
}
